...
another thing this plot show is that the higher the the quality the box go down i seems that it is rightskeed 
...
using the range diff i can observe it , but 
...
```
this doesn't show a clear relation between them but we can see that in the begging the points ara close and when the critic acid increse the point git wider 
